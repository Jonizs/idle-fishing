...
(() => {
  ...
  const WADE_UPG = [
    ...
    { id: "darkArts",     name: "Dark Arts",    lvl: 70, max: 1,
      desc: "Tier 1 scroll drops rise to 0.01% per fish tier, and 0.002% per fish tier drops a Spyglass, the tier 2 scroll craft material.",
      costs: [60000000] },
    ...
    { id: "fog",          name: "The Fog",     lvl: 71, max: 1,
      desc: "0.0001% per fish tier to fog the screen for 10 seconds. The fog gives +75% fishing speed and a 2% chance per fish tier to catch a rare area respective fish.",
      costs: [72000000] },
